          ...
          <Card className="bg-slate-900/60 border-slate-700/30 backdrop-blur-xl">
            ...
            <CardContent>
              <div className="relative aspect-[4/3] rounded-lg overflow-hidden bg-slate-800">
                <ImageWithFallback 
                  src="https://images.unsplash.com/photo-1551179231-dc26ffae5fbe?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxub3J0aGVhc3QlMjBpbmRpYSUyMG1hcHxlbnwxfHx8fDE3NTcxODg2NTl8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
